...
void ProgramShader::setVec3(const std::string &name, float value[3]) const
{
...
void ProgramShader::setVec4(const std::string &name, float value[4]) const
{
    glUniform4f(glGetUniformLocation(program, name.c_str()), value[0],value[1],value[2],value[3]);
}
